        ...
        <section className="resume-container">
            ...
            <section className="resume-intro">
                <p className="introduction">
                    Experienced release manager with over 15 years of expertise
                    in software engineering and release management. Skilled in
                    identifying risks and resolving complex issues, designing
                    and implementing effective solutions, and leading
                    cross-functional teams through critical phases of the
                    project lifecycle. Deep knowledge of software development
                    life cycle processes and methodologies. Key achievements
                    include enhancing release stability and automation,
                    achieving a 73% reduction in rollbacks in 2022. Looking to
                    apply this expertise in a dynamic role, contributing to both
                    startup and enterprise application development.
                </p>
